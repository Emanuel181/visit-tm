    ...
    >
      ...
      >
        <Stack spacing={2} useFlexGap sx={{ width: { xs: '100%', sm: '70%' } }}>
          ...
          >Universitatea de West din Timisoara
        ...
        <Box
          ...
          sx={{
            ...
            overflow: 'hidden', // To ensure the iframe's borderRadius is visible
          }}
        >
          <iframe
        title="Upt/Uvt"
        ...
        web-share
        src="https://sketchfab.com/models/52bd359070ae495c94209db5638f5b6f/embed"
