...
import Imagine from './download.jpg';
        ...
        <Grid item xs={12} md={6}>
          <div>
            ...
            <Typography
              ...
              sx={{ mb: { xs: 2, sm: 4 } }}
            >
              Prow is the first product-oriented conference in Timișoara, focused on enhancing the community’s understanding of this industry and showcasing some of the best use-cases and entrepreneurial pieces of advice.Fostering the power of innovation and people altogether is the essence of Prow. Products grow hand in hand with systematic knowledge. 
